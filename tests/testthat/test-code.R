test_that("code", {
  ...
  expect_identical(pars(code), c("bar", "foo", "foo2", "mu_y", "sigma_pi", "sigma_y", "tau_y"))

  expect_identical(pars(code, "primary"),
                   c("foo", "foo2", "mu_y", "sigma_pi", "tau_y"))

  expect_identical(pars(code, "primary", scalar = TRUE), c("mu_y", "sigma_pi", "tau_y"))
